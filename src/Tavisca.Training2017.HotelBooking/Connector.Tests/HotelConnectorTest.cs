...
namespace Tavisca.Training2017.HotelBookingWeb.Tests
{
    public class HotelControllerTest
    {
        ...
        public void Search_Should_Give_Valid_Result_When_SearchRQ_Is_Complete()
        {
            ...
            StaticConnectorConfiguration configurationService = new StaticConnectorConfiguration("Pune",DateTime.Now, DateTime.Now.AddDays(7), 101);
        ...
        public HotelSearchRQ GetHotelSearchRQTestData()
        {
            ...
            loc.GeoCode = new GeoCode() { Latitude = 27.173891f, Longitude = 78.042068f };
