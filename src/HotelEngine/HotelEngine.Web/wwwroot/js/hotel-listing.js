...
function renderPaginationSection() {
    var html = '<div class="col-md-6 col-md-offset-3  col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1"><nav aria-label="Page navigation"><ul class="pagination"></ul></nav></div>';
